...
import { ArrowRight, Play, CheckCircle2, FileText, Download } from "lucide-react";

export default function DigitalEvidence() {
  return (
    <section id="evidence" className="py-32 bg-brand-light text-brand-dark relative overflow-hidden">
      {/* Background accents */}
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6 bg-[url('data:image/svg+xml;base64,')]">
               ...
               <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                     <div className="relative aspect-video bg-gray-800 rounded overflow-hidden group cursor-pointer">
                     ...
                     <div className="relative aspect-video bg-gray-600 rounded overflow-hidden group cursor-pointer">
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"></div>
                  ...
                  <div className="relative h-[160px] bg-gradient-to-br from-brand-midnight to-brand-dark rounded overflow-hidden border border-gray-200">
