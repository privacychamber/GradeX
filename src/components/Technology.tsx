...
export const Technology = () => {
  return (
    <section className="relative w-full bg-warm-white pt-32 pb-32">
      
      <div className="container px-6 relative z-10">
        <div className="mb-16">
          <div className="inline-block relative">
             <div className="absolute inset-0 bg-primary/20 blur-xl rounded-full" />
             <h2 className="display-sm text-navy relative z-10 drop-shadow-2xl">A DIFFERENT WAY INSIDE.</h2>
          </div>
          <StaggeredText 
            ...
            className="body text-dark-grey mt-6 max-w-xl text-lg" 
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-muted-grey/80 backdrop-blur-md border border-navy/10 hover:border-primary/50 transition-colors p-8 md:p-12 min-h-[400px] flex flex-col justify-end"
          >
             ...
             <div className="relative z-10 w-full max-w-md">
                ...
                <h3 className="h2 mb-4 text-navy">Precision Engineered</h3>
          ...
          <motion.div 
            ...
            className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-muted-grey/80 backdrop-blur-md border border-navy/10 hover:border-primary/50 transition-colors p-8 md:p-12 min-h-[400px] flex flex-col md:flex-row items-center gap-8"
          >
             ...
             <div className="relative z-10 flex-1">
                ...
                <h3 className="h2 mb-4 text-navy">Comprehensive Coverage</h3>
                <p className="body text-dark-grey">
             ...
             <div className="relative z-10 w-full md:w-1/3 flex justify-center">
                ...
                <div className="relative w-48 h-48 rounded-full border border-navy/10 flex items-center justify-center bg-navy/5">
                   <div className="w-32 h-32 rounded-full border border-primary/30 bg-primary/10 flex items-center justify-center animate-pulse">
                      <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center shadow-[0_0_30px_rgba(212,175,55,0.6)]">
                         <span className="text-warm-white font-bold">100%</span>
                      </div>
                   </div>
                </div>
             </div>
